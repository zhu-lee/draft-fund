...
public final class FieldUtils {
     ...
     *
     * @param t    the target object from which to get the field
    ...
    /**
     * To find out matched {@link Field} marked as {@link ProtoField} annotation
     *
     * @param targetClass taget class
     * @return found {@link Field} list
     */
    public static List<Field> findMatchedFields(Class targetClass, Class annoClass) {
        ...
        do {
            ...
            for (int i = 0; i < fields.length; i++) {
                Annotation protobuf = fields[i].getAnnotation(annoClass);
                if (protobuf != null) {
                    ret.add(fields[i]);
                }
            }
