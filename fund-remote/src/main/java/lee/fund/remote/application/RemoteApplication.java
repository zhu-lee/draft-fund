package lee.fund.remote.application;
 ...
 * Desc:
 */
public class RemoteApplication extends AbstractApplication {
    private final Logger logger = LoggerFactory.getLogger(ClassesUtils.class);
    private RemoteServer rpcServer;

    public RemoteApplication(Class<?> bootStrap, Configuration configuration, String[] args) {
        super(bootStrap, args, configuration);
        this.rpcServer = new RemoteServer(configuration);
    }
